...
echo_and_run cd "/home/maanz-ai/ahmed-workspace/src/ros-bridge/ros_compatibility"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/maanz-ai/ahmed-workspace/src/ros-bridge/ros_compatibility/setup.py" \
     \
    build --build-base "/home/maanz-ai/ahmed-workspace/build/ros-bridge/ros_compatibility" \
    install \
    --root="${DESTDIR-/}" \
