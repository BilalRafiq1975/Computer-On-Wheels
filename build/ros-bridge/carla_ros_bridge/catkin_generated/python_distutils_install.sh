...
echo_and_run cd "/home/maanz-ai/ahmed-workspace/src/ros-bridge/carla_ros_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/maanz-ai/ahmed-workspace/src/ros-bridge/carla_ros_bridge/setup.py" \
     \
    build --build-base "/home/maanz-ai/ahmed-workspace/build/ros-bridge/carla_ros_bridge" \
    install \
    --root="${DESTDIR-/}" \
