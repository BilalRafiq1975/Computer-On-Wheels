...
echo_and_run cd "/home/maanz-ai/ahmed-workspace/src/ros-bridge/carla_manual_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/maanz-ai/ahmed-workspace/src/ros-bridge/carla_manual_control/setup.py" \
     \
    build --build-base "/home/maanz-ai/ahmed-workspace/build/ros-bridge/carla_manual_control" \
    install \
    --root="${DESTDIR-/}" \
